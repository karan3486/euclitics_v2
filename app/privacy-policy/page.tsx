      ...
      <div className="py-16 md:py-24">
        <Container>
          <div className="mx-auto max-w-4xl">
            <h1 className="mb-8 text-2xl font-bold text-center md:text-2xl">Privacy Policy</h1>
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p>
                At Euclitics, we respect your privacy and are committed to protecting your personal data. 
              ...
              <h2 className="text-xl font-semibold mt-8 mb-4">9. Changes to the Privacy Policy</h2>
              <p>
              ...
              <p className="font-medium">
                Email: privacy@euclitics.com<br />
